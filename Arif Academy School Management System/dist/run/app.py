...
def fee_payment():
    ...
    try:
        ...
        if len(regs)>0:
            ...
            close=int(data['Total'])+int(open)
            close2=int(open2)-int(data['Total'])
...
def add_student():
    ...
    try:
        if int(data['INDEX'])==0:
            ...
            print(open)
            close=int(data['annual'])+int(open)
            print('reached3.75')
            open3=int(close)
            print("reached4")
            open4=get_close(df[df['Head']=='4030: Admission Fee'])
            close2=int(open2)+int(data['annual'])
            close3=int(open3)+int(data['admission'])
            close4=int(open4)+int(data['admission'])
...
def salary_payment():
    ...
    try:
        ...
        if data['MEDICAL'] is not None and data['MEDICAL']!='0':
            ...
            close=int(data['MEDICAL'])+int(open)
            close2=int(open2)+int(data['MEDICAL'])
            open3=int(close2)
            open4=get_close(df[df['Head']=="1010: Current (Bank Account)"])
            close3=int(open3)-int(data['MEDICAL'])
            close4=int(open4)-int(data['MEDICAL'])
        ...
        if data['Eidi'] is not None and data['Eidi']!='0':
            ...
            open2=get_close(df[df['Head']=="2115: Accrued Employee Benefits"])
            close=int(open)+int(data['Eidi'])
            close2=int(open2)+int(data['Eidi'])
            open3=int(close2)
            open4=get_close(df[df['Head']=="1010: Current (Bank Account)"])
            close3=int(open3)-int(data['Eidi'])
            close4=int(open4)-int(data['Eidi'])
        ...
        if data['ADVANCED'] is not None and data['ADVANCED']!='0':
            ...
            if int(data['ADVANCED'])<0:
                ...
                close=int(open)+int(data['ADVANCED'])
                close2=int(open2)-int(data['ADVANCED'])
        ...
        close=int(open)+int(basic)
        close2=int(open2)+int(basic)
        open3=close2
        open4=get_close(df[df['Head']=="1010: Current (Bank Account)"])
        close3=int(open3)-int(basic)
        close4=int(open4)-int(basic)
...
def general_voucher():
    ...
    if (data['category']=='Assets'):
        if 'Contra' in data['head']:
            ...
            close=int(open)+int(data['amount'])
            if data['amount']>0:
                close=int(open)+int(data['amount'])
...
def misc_expense_post():
    ...
    if (data['category']=='Assets'):
        if 'Contra' in data['head']:
            ...
            close=int(open)+int(data['amount'])
            close2=int(open2)-int(data['amount'])
