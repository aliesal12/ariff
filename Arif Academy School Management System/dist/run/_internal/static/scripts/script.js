            ...
            if (adv_payment != null) {
              ...
              if (add_payment != null) {
                ...
                if (total_amount != null) {
                  var regex = /^(0|1[0-2]|[1-9])(,(0|1[0-2]|[1-9]))*$/;
                  do {
                    var month_spe = prompt(
                      "Enter the month/s number, advance being paid for(0-12):"
                    );
                  } while (
              ...
              if (eidi != null) {
                ...
                if (adv != null) {
                  ...
                  console.log(add_payment);
                    console.log("Hello")
                    do {
                      var date = prompt("Enter Date of payment(DD/MM/YYYY):");
            ...
            data[category].forEach((item) => {
              ...
              expenseItem.addEventListener("click", () => {
                ...
                paymentTypeForm.onsubmit = (e) => {
                  ...
                  regex = /^\d+$/;
                  do {
                    const amount = prompt(`Enter amount for ${item}:`);
...
teacherPopupButtons.forEach((button, index) => {
  button.addEventListener("click", () => {
    ...
    if (cnic != null) {
      ...
      do {
        var doj = prompt(
          "Enter Teacher Date of Joining (DD-MM-YYYY) (Leave blank if not applicable):"
        );
...
studentPopupButtons.forEach((button, index) => {
  button.addEventListener("click", () => {
    ...
    do {
      var dob = prompt(
        "Enter Student Date of Birth (DD-MM-YYYY) (Leave blank if not applicable):"
      );
    ...
    do {
      var contact = prompt(
        "Enter Student Contact (Leave blank if not applicable):"
      );
    } while (!regex.test(contact) & (contact != null) & (contact != ""));
    do {
      var contact2 = prompt(
        "Enter Student Alternate Contact (Leave blank if not applicable):"
      );
